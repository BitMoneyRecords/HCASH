Contributing to HCASH Core
============================

The HCASH Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HCASH Core project, and is not to be
confused with overall HCASH Network Protocol consensus changes.

Whether a pull request is merged into HCASH Core rests with the project merge
...
Patches that change HCASH consensus rules are considerably more involved than
...
Where a patch set proposes to change the HCASH consensus, it must have been
...
The project leader is the release manager for each HCASH Core release.
