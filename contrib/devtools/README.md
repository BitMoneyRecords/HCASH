...
HCASH-Project/HCASH repository.
...
Setup
---------
Configuring the github-merge tool for the HCASH repository is done in the following way:

    git config githubmerge.repository HCASH-Project/HCASH
...
A script to optimize png files in the HCASH
