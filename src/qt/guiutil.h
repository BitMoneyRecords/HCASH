...
/** Utility functions used by the HCASH Qt UI.
 */
namespace GUIUtil
{
...
// Render HCASH addresses in monospace font
...
// Parse "HCASH:" URI into recipient object, return true on successful parsing
