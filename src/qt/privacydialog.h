...
public:
    ...
    void setZHCASHControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzHCASH_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzHCASH_clicked();
    void on_pushButtonZHCASHControl_clicked();
