                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HCASH Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HCASH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and HCASH: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHCASH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HCASH Core"), this);
    aboutAction->setStatusTip(tr("Show information about HCASH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HCASH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HCASH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HCASH addresses"));
    ...
    openAction->setStatusTip(tr("Open a HCASH: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HCASH Core help message to get a list with possible HCASH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HCASH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HCASH network", "", count));
}
...
{
    QString strTitle = tr("HCASH Core"); // default title
