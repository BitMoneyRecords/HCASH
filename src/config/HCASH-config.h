/* src/config/HCASH-config.h.  Generated from HCASH-config.h.in by configure.  */
/* src/config/HCASH-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HCASH_CONFIG_H

#define HCASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.HCASH.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "HCASH Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "HCASH Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "HCASH"
