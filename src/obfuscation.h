...
{
public:
    /// Is the inputs associated with this public key? (and there is 50000 HCASH - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of HCASH.
