...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00003209ab65c9ecfdf07de4c3e64dd6b5d3863af89b1efdb5ff1570b0e4fe8c"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 32888;
        bnProofOfWorkLimit = ~uint256(0) >> 1; // HCASH starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // HCASH: 1 day
        nTargetSpacing = 1 * 60; //HCASH: 1 minute
        nMaturity = 10;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 20000000* COIN; //500,000,000
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Hello HCASH2";
...
/*
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("00003209ab65c9ecfdf07de4c3e64dd6b5d3863af89b1efdb5ff1570b0e4fe8c"));
        assert(genesis.hashMerkleRoot == uint256("2ea9f1d25cfe4495f94bd257cef2cd2d34879e8fc2ee415aba5c7daf7a92f0af"));

       vSeeds.push_back(CDNSSeedData("212.86.108.214", "212.86.108.214"));
      vSeeds.push_back(CDNSSeedData("212.86.102.155", "212.86.102.155"));
       vSeeds.push_back(CDNSSeedData("212.86.102.159", "212.86.102.159"));
       vSeeds.push_back(CDNSSeedData("149.28.52.253", "149.28.52.253"));

       vSeeds.push_back(CDNSSeedData("45.63.1.163", "45.63.1.163"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.HCASH.io", "testnet.HCASH.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.HCASH.io", "testnet1.HCASH.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet2.HCASH.io", "testnet2.HCASH.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // HCASH: 1 day
        nTargetSpacing = 1 * 60;        // HCASH: 1 minutes
